...
<html>
<head>
<title>Launch Page: Kit Cat Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="kitForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Kit Cat, Level 1</option>
				<option value="02">Kit Cat, Level 2</option>
				<option value="03">Kit Cat, Level 3</option>
				<option value="04">Kit Cat, Level 4</option>
				<option value="05">Kit Cat, Level 5</option>
				<option value="06">Kit Cat, Level 6</option>
				<option value="07">Kit Cat, Level 7</option>
				<option value="08">Kit Cat, Level 8</option>
				<option value="09">Kit Cat, Level 9</option>
				<option value="10">Kit Cat, Level 10</option>
			  </select>
        ...
        {
            $("#kitForm").attr('action', "kit/kit"+ $("#level").val() +  ".php");
        });
