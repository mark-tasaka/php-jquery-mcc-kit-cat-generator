...
<html>
<head>
<title>Iconic NPC Kit Cat Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_kit.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_kit_post.css">
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
    ...
    <span id="additionalLanguages"></span>
       ...
       <span id="manimalSubtype">Feline: Tiger</span>
  ...
  <script>
	...
	/*
	 Character() - Kit Cat Character Constructor
	*/
	function Character() {
	
    let strength = <?php echo $totalArtifactStrength ?> + rollDice(6, 4, 1, 0);
    let agility = rollDice(6, 4, 1, 4);
    ...
    let manimal = getKit();
		...
		let manimalCharacter = {
			...
			"speed": 35 + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
			"modifiedSpeed": 35 - <?php echo $speedReduction ?> + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
    ...
    /*getKit() return the statistics for the Manimal per level*/  
    function getKit() {
	var manimal = [
	...
	return manimal[4]; 
       ...
       let imgData = "images/kit_character_sheet.png";
